...
<div class="card-body bg-light mt-5">
	...
	<form action="<?php echo RUTA_URL;?>/paginas/agregar" method="POST">
		<div class="form-group">
			...
			<input type="text" name="nombre_Tarea" class="form-control form-control-lg" >
		</div>
		<div class="form-group">
			...
			<div class="input-group date" id="datetimepickerFechaIni" data-target-input="nearest">
	                <input type="text" class="form-control datetimepicker-input"  name="fecha_Inicio_tarea" id="fecha_Inicio_tarea" data-target="#datetimepickerFechaIni"/>
       ...
       <div class="form-group">
			...
			<div class="input-group date" id="datetimepickerFechaFin" data-target-input="nearest">
	                <input type="text" class="form-control datetimepicker-input"  name="fecha_fin_tarea" id="fecha_fin_tarea" data-target="#datetimepickerFechaFin"/>
		...
		<div class="form-group">
			...
			<textarea  name="comentarios" class="form-control form-control-lg"></textarea>
		</div>
		<input type="submit" class="btn btn-success" id="btn"  value="añadir tarea">
	</form>
</div>
